...
import { getBookByTop } from "../../api/bookApi";
...
<template>
  <div class="horizontal-grid">
    <div class="h-grid" ref="grid">
      <div @click="goDetail(b)" v-for="b in books" :key="b.id" class="book-card" :style="{ backgroundImage: `url(${b.imageUrl || b})`}" style="height: 250px;">
